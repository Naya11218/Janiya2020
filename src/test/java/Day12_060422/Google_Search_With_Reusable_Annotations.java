...
public class Google_Search_With_Reusable_Annotations extends Reusable_Annotation_Class {
        ...
        public void SearchForKeyword(){
            ...
            Reusable_Actions_Logger.submitAction(driver,"//*[@name='btnK']",logger,"Google Search Button");
     ...
     */
        ...
        public void CaptureSearchNumber(){
            ...
            String result = Reusable_Actions_Logger.getTextAction(driver,"//*[@id='Result-stats']",logger,"Search Result Text");
